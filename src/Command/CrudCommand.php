...
#[AsCommand(
    name: 'symfrop:crud',
    description: 'Create an entity crud using symfrop format',
)]
class CrudCommand extends Command
{
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->controllerClassName = $this->io->ask(
            sprintf('Choose a name for your controller class (e.g. <fg=yellow>%s</>)', $defaultControllerClass),
            $defaultControllerClass
        );

        $this->generateTests = $this->io->confirm('Do you want to generate tests for the controller?. [Experimental]', false);
    }

    // public function generate(InputInterface $input, ConsoleStyle $this->io, Generator $generator): void
    public function execute(InputInterface $input, OutputInterface $output): int
    {

        $generator = $this->formTypeRenderer->getGenerator();
        ...
        if ($this->generateTests) {
            ...
            $generator->generateFile(
                ...
                __DIR__ .  '/Resources/skeleton/' . ($usesEntityManager ? 'crud/test/Test.EntityManager.tpl.php' : 'crud/test/Test.tpl.php'),
                [
                    'use_statements' => $useStatements,
            ...
            if (!class_exists(WebTestCase::class)) {
                $this->io->caution('You\'ll need to install the `symfony/test-pack` to execute the tests for your new controller.');
            }
        }
